...
const ICON_STEAM   = "data:image/png;base64,";
const ICON_GC      = "data:image/png;base64,";
const ICON_FACEIT  = "data:image/png;base64,";
...
function MixTab({isAdmin,setShowLogin}){
  ...
  useEffect(()=>{
    fb.get("/mix-config").then(d=>{
      if(d){setConfig(d);setEditForm(d);}
      setLoadingConfig(false);
    });
    fb.get("/mix-players").then(d=>{
      setMixPlayers(toArr(d));
  ...
  const saveConfig=async()=>{
    ...
    await fb.set("/mix-config",{...editForm,updatedAt:Date.now()});
    setConfig({...editForm});
    setEditMode(false);
  ...
  const copyPix=()=>{
    const key=config?.pix||editForm.pix;
    if(key){navigator.clipboard?.writeText(key);setCopiedPix(true);setTimeout(()=>setCopiedPix(false),2000);}
  };
  ...
  const signup=async()=>{
    ...
    const d=await fb.get("/mix-players");
    setMixPlayers(toArr(d));
    setSignupName("");setSignupPhone("");
    setSigningUp(false);setSignupDone(true);
    setTimeout(()=>setSignupDone(false),3500);
  };

  const removePlayer=async(id)=>{
    await fb.delete(`/mix-players/${id}`);
    setMixPlayers(p=>p.filter(x=>x.id!==id));
  };

  const maskPhone=phone=>{
    if(!phone)return"—";
    const c=phone.replace(/\D/g,"");
    return c.length>=6?`(${c.slice(0,2)}) ****-${c.slice(-4)}`:"****";
  };
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-2xl overflow-hidden">
        <div className="border-b border-zinc-800 px-6 py-4 flex items-center justify-between bg-zinc-900">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-zinc-100 font-black text-lg tracking-wide uppercase">Próximo Mix</h2>
              <p className="text-orange-400 font-mono text-xs">Counter-Strike 2</p>
            </div>
          </div>
          <div className="flex items-center gap-2">
            {isAdmin&&!editMode&&(
              <button onClick={()=>setEditMode(true)}
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-orange-500/40 bg-orange-500/10 text-orange-400 font-mono text-xs hover:bg-orange-500/20 transition-colors">
                ✏ Editar
              </button>
            )}
            {!isAdmin&&(
              <button onClick={()=>setShowLogin(true)}
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-zinc-700 text-zinc-500 font-mono text-xs hover:border-zinc-500 transition-colors">
                🔒 Admin
              </button>
            )}
          </div>
          ...
          :editMode&&isAdmin?(
            <div className="flex flex-col gap-4">
              <div className="grid grid-cols-2 gap-4">
                {[
                  {l:"📍 Local",k:"local",ph:"Ex: Arena CS Cuiabá"},
                  {l:"👥 Qtd. Jogadores",k:"maxPlayers",type:"number",ph:"10"},
                  {l:"📅 Data",k:"date",type:"date",ph:""},
                  {l:"🕐 Hora",k:"time",type:"time",ph:""},
                  {l:"💰 Valor (R$)",k:"value",type:"number",ph:"0.00"},
                ].map(({l,k,type="text",ph})=>(
                  <div key={k} className="flex flex-col gap-1">
                    <label className="text-xs text-zinc-500 font-mono uppercase tracking-widest">{l}</label>
                    <input type={type} step={k==="value"?"0.01":undefined} min={k==="value"||k==="maxPlayers"?"0":undefined}
                      value={editForm[k]||""} onChange={e=>setEditForm(f=>({...f,[k]:e.target.value}))} placeholder={ph}
                ...
                <div className="flex flex-col gap-1">
                  <label className="text-xs text-zinc-500 font-mono uppercase tracking-widest">🎮 Plataforma</label>
                  <select value={editForm.platform||"Gamers Club"} onChange={e=>setEditForm(f=>({...f,platform:e.target.value}))}
                    className="bg-zinc-800 border border-zinc-700 rounded-lg px-3 py-2 text-sm text-zinc-200 focus:outline-none focus:border-orange-500">
              ...
              <div className="flex flex-col gap-1">
                <label className="text-xs text-zinc-500 font-mono uppercase tracking-widest">💳 Chave PIX</label>
                <input value={editForm.pix||""} onChange={e=>setEditForm(f=>({...f,pix:e.target.value}))}
                  placeholder="CPF, e-mail, telefone ou chave aleatória"
                  className="bg-zinc-800 border border-zinc-700 rounded-lg px-3 py-2 text-sm text-zinc-200 focus:outline-none focus:border-orange-500"/>
              </div>
              <div className="flex gap-3 pt-1">
                <button onClick={saveConfig} disabled={savingConfig}
                  className="flex-1 bg-orange-500 hover:bg-orange-400 disabled:bg-zinc-700 text-black font-mono font-bold py-2.5 rounded-xl text-sm uppercase flex items-center justify-center gap-2 transition-colors">
                  {savingConfig&&<Spinner/>}💾 Salvar
                </button>
                <button onClick={()=>{setEditMode(false);setEditForm(config||editForm);}}
                  className="px-5 bg-zinc-800 hover:bg-zinc-700 text-zinc-400 font-mono py-2.5 rounded-xl text-sm">
                  Cancelar
                </button>
              </div>
            </div>
            ...
            <div className="flex flex-col gap-5">
              <div className="grid grid-cols-2 gap-3 sm:grid-cols-3">
                ...
                <InfoTile icon="📅" label="Data"
                  value={config.date?new Date(config.date+"T12:00").toLocaleDateString("pt-BR",{day:"2-digit",month:"long",year:"numeric"}):"—"}/>
                <InfoTile icon="🕐" label="Hora" value={config.time||"—"}/>
                <InfoTile icon="🎮" label="Plataforma" value={config.platform||"—"} accent="orange"/>
                <InfoTile icon="💰" label="Inscrição"
                  value={config.value&&Number(config.value)>0?`R$ ${Number(config.value).toFixed(2)}`:"Gratuito"} accent="green"/>
                <InfoTile icon="👥" label="Vagas"
                  value={`${mixPlayers.length} / ${config.maxPlayers}`}
                  accent={spotsLeft===0?"red":spotsLeft<=3?"orange":"green"}/>
              </div>
              <div>
                <div className="flex justify-between text-xs font-mono mb-1.5">
                  <span className="text-zinc-500">Vagas preenchidas</span>
                  <span className={spotsLeft===0?"text-red-400":spotsLeft<=3?"text-orange-400":"text-green-400"}>
                    {spotsLeft===0?"LOTADO":`${spotsLeft} vaga(s) livre(s)`}
                  </span>
                </div>
                <div className="w-full h-2 bg-zinc-800 rounded-full overflow-hidden">
                  <div className={`h-full rounded-full transition-all duration-700 ${spotsLeft===0?"bg-red-500":spotsLeft<=3?"bg-orange-500":"bg-green-500"}`}
                    style={{width:`${pct}%`}}/>
                </div>
              </div>
              {config.pix&&(
                <div className="flex items-center gap-3 bg-zinc-800/60 border border-zinc-700 rounded-xl px-4 py-3">
                  <div className="flex-1 min-w-0">
                    <div className="text-xs text-zinc-500 font-mono uppercase mb-1">💳 Chave PIX para pagamento</div>
                    <div className="text-zinc-200 font-mono text-sm font-bold truncate">{config.pix}</div>
                  </div>
                  <button onClick={copyPix}
                    className={`shrink-0 flex items-center gap-1.5 px-4 py-2 rounded-lg font-mono text-sm font-bold transition-all ${copiedPix?"bg-green-600 text-white":"bg-zinc-700 hover:bg-zinc-600 text-zinc-200"}`}>
            ...
            <div className="text-center text-zinc-600 font-mono py-10 text-sm">
              {isAdmin?"Clique em 'Editar' para configurar o próximo Mix.":"Nenhum mix configurado ainda. Aguarde o administrador."}
            </div>
          )}
        </div>
      </div>

      {/* ══ CARD 2 — INSCRIÇÃO DOS JOGADORES ══ */}
      <div className="bg-zinc-900 border border-zinc-800 rounded-2xl overflow-hidden">
        <div className="border-b border-zinc-800 px-6 py-4 flex items-center justify-between bg-zinc-900">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-green-600 flex items-center justify-center text-black font-black text-base">IN</div>
            <div>
              <h2 className="text-zinc-100 font-black text-lg tracking-wide uppercase">Inscrição</h2>
              <p className="text-green-400 font-mono text-xs">{mixPlayers.length} jogador(es) inscrito(s)</p>
            </div>
          </div>
          {config&&(
            spotsLeft===0
              ?<span className="text-red-400 font-mono text-xs border border-red-500/30 bg-red-500/10 px-3 py-1.5 rounded-lg font-bold">🔴 VAGAS ESGOTADAS</span>
              :<span className="text-green-400 font-mono text-xs border border-green-500/30 bg-green-500/10 px-3 py-1.5 rounded-lg font-bold">🟢 INSCRIÇÕES ABERTAS</span>
          )}
        </div>
        ...
        <div className="p-6 flex flex-col gap-6">
            ...
            <div className="bg-zinc-800/40 border border-zinc-700/50 rounded-xl p-5">
              ...
              {signupDone?(
                <div className="text-center py-6">
                  ...
                  <div className="text-green-400 font-bold text-lg">Inscrição confirmada!</div>
                  <div className="text-zinc-500 text-sm mt-1">Você está na lista. Boa sorte! 🔥</div>
                </div>
              ):(
                <div className="flex flex-col gap-3">
                  <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                    <div className="flex flex-col gap-1">
                      <label className="text-xs text-zinc-500 font-mono uppercase">👤 Nome / Nickname *</label>
                      <input value={signupName} onChange={e=>setSignupName(e.target.value)} placeholder="Ex: s1mple"
                        className="bg-zinc-900 border border-zinc-700 rounded-lg px-3 py-2.5 text-sm text-zinc-200 placeholder-zinc-600 focus:outline-none focus:border-green-500 transition-colors"/>
                    </div>
                    <div className="flex flex-col gap-1">
                      <label className="text-xs text-zinc-500 font-mono uppercase">📱 Telefone / WhatsApp *</label>
                      <input value={signupPhone} onChange={e=>setSignupPhone(e.target.value)} placeholder="(11) 99999-9999"
                        className="bg-zinc-900 border border-zinc-700 rounded-lg px-3 py-2.5 text-sm text-zinc-200 placeholder-zinc-600 focus:outline-none focus:border-green-500 transition-colors"/>
                      <p className="text-zinc-600 text-[10px] font-mono mt-0.5">🔒 Número oculto para outros jogadores</p>
                    </div>
                  </div>
                  <button onClick={signup} disabled={signingUp||!signupName.trim()||!signupPhone.trim()}
                    className="w-full bg-green-600 hover:bg-green-500 disabled:bg-zinc-700 disabled:text-zinc-500 text-black font-mono font-black py-3 rounded-xl text-sm uppercase tracking-wider transition-all flex items-center justify-center gap-2">
                    {signingUp?<><Spinner/>Processando...</>:"⚔️ ENTRAR NO MIX"}
                  </button>
                </div>
              )}
            </div>
          ...
          <div>
            <div className="flex items-center gap-2 mb-3">
              <h3 className="text-zinc-400 font-mono text-xs uppercase tracking-widest">Lista de Participantes</h3>
              <span className="w-5 h-5 rounded-full bg-green-500/20 text-green-400 text-xs flex items-center justify-center font-bold">{mixPlayers.length}</span>
            </div>
            {loadingPlayers?(
              <div className="flex justify-center py-6"><Spinner/></div>
            ):mixPlayers.length===0?(
              <div className="text-center text-zinc-700 font-mono py-10 border border-dashed border-zinc-800 rounded-xl text-sm">
              ...
              <div className="flex flex-col gap-2">
                {mixPlayers.map((p,i)=>(
                  <div key={p.id} className="flex items-center gap-3 px-4 py-3 bg-zinc-800/50 border border-zinc-700/50 rounded-xl hover:border-zinc-600 transition-colors">
                    ...
                    <div className="w-9 h-9 rounded-full bg-orange-500/20 border border-orange-500/30 flex items-center justify-center text-sm font-black text-orange-400 shrink-0">
                      {p.name?.charAt(0)?.toUpperCase()||"?"}
                    </div>
                    <div className="flex-1 min-w-0">
                      <div className="text-zinc-100 font-bold text-sm truncate">{p.name}</div>
                      <div className="text-zinc-600 font-mono text-xs mt-0.5">
                        {isAdmin?<span className="text-zinc-400">📱 {p.phone}</span>:<span>📱 {maskPhone(p.phone)}</span>}
                      </div>
                    </div>
                    <div className="flex items-center gap-2 shrink-0">
                      <span className="flex items-center gap-1.5 text-xs font-mono px-2.5 py-1 rounded-full border border-green-500/30 bg-green-500/10 text-green-400 font-bold">
                        <span className="w-1.5 h-1.5 rounded-full bg-green-400"/>
                        {p.status||"Confirmado"}
                      </span>
                      {isAdmin&&(
                        <button onClick={()=>removePlayer(p.id)} className="text-zinc-600 hover:text-red-400 transition-colors text-sm px-1">✕</button>
                      )}
                    </div>
                  </div>
                ))}
            ...
            return(
              <div key={p.id}>
                <div onClick={()=>setSelected(isOpen?null:p.id)}
                  ...
                  <div className="col-span-2"><span className="text-zinc-400 text-xs truncate">{p.city||"—"}</span></div>
                ...
                <div className="flex gap-1 items-center">
                  ...
                  {p.steamUrl&&(
                    <a href={p.steamUrl.startsWith("http")?p.steamUrl:"https://"+p.steamUrl} target="_blank" rel="noopener noreferrer" onClick={e=>e.stopPropagation()}
                       ...
                       <img src={ICON_STEAM} alt="Steam" className="w-3.5 h-3.5 object-contain"/> <span className="text-[10px]">↗</span>
                    </a>
                  )}
                </div>
...
// ─── ABA: TABELAS (Double Elimination) ───────────────────────
function genBracket(teams){
  ...
  while(prev.length>1){
    ...
    for(let i=0;i<prev.length;i+=2){
      ...
      prev[i].nextWin=m.id;prev[i+1].nextWin=m.id;cur.push(m);
    }
    W.push(cur);prev=cur;wr++;
  }
  const wFinal=W[W.length-1][0];wFinal.label="Winner Final";
  const L=[];
  const lr1Pairs=n===4?[[0,1]]:[[0,3],[1,2]];
  const lR1=lr1Pairs.map(([a,b])=>({id:mid(),bracket:"L",round:1,team1:null,team2:null,score1:null,score2:null,winner:null,loser:null,nextWin:null,nextLose:null,feeder1:wR1[a].id,feeder2:wR1[b].id}));
  ...
  L.push(lR1);
  let lPrev=lR1;let lr=2;
  const wLosersPerRound=W.slice(1,-1);
  for(let wi=0;wi<wLosersPerRound.length;wi++){
    const wLosers=wLosersPerRound[wi];
    const challenge=lPrev.map((lm,i)=>{
      ...
      lm.nextWin=m.id;wm.nextLose=m.id;return m;
    });
    L.push(challenge);lr++;
    if(challenge.length>1){
      ...
      for(let i=0;i<challenge.length;i+=2){
        const m={id:mid(),bracket:"L",round:lr,team1:null,team2:null,score1:null,score2:null,winner:null,loser:null,nextWin:null,nextLose:null};
        challenge[i].nextWin=m.id;challenge[i+1].nextWin=m.id;norm.push(m);
      }
      L.push(norm);lr++;lPrev=norm;
    }else{lPrev=challenge;}
  }
...
function MatchCard({m,isAdmin,onClick}){
  const isDone=m.winner!==null;
  const isGF=m.bracket==="GF";
  const isLFin=m.label==="Lower Final";
  return(
    <div onClick={()=>isAdmin&&onClick(m)}
      className={`rounded-lg border overflow-hidden w-44 transition-all ${isAdmin?"cursor-pointer hover:border-orange-500/60":""} ${isGF?"border-yellow-500/50 bg-yellow-500/5":isLFin?"border-purple-500/40 bg-purple-500/5":isDone?"border-zinc-700 bg-zinc-800/60":"border-zinc-700 bg-zinc-800/30"}`}>
...
function BracketColumn({label,rounds,isAdmin,onMatch}){
  return(
    <div className="flex flex-col gap-1 min-w-[11rem]">
      ...
      <div className="flex flex-col gap-2">
        {rounds.map(m=><MatchCard key={m.id} m={m} isAdmin={isAdmin} onClick={onMatch}/>)}
      </div>
    </div>
  );
}
...
function TournamentTab({isAdmin,setShowLogin}){
  ...
  const createTournament=async()=>{
    ...
    if(res?.name){const nt={...t,id:res.name};setTournaments(ts=>[nt,...ts]);setCurrent(nt);setView("bracket");}
    setCreating(false);
  };
  ...
  const saveMatchResult=async()=>{
    ...
    const place=(mid,name)=>{if(!mid||!map[mid])return;if(!map[mid].team1)map[mid].team1=name;else if(!map[mid].team2)map[mid].team2=name;};
    place(updatedMatch.nextWin,winner);place(updatedMatch.nextLose,loser);
    ...
    setCurrent(updated);setTournaments(ts=>ts.map(t=>t.id===current.id?updated:t));
          ...
          <div className="flex flex-col gap-1">
            ...
            <div className="flex gap-2">
              {[{v:"md3",l:"MD3"},{v:"md1",l:"MD1"}].map(f=>(
                <button key={f.v} onClick={()=>setTFormat(f.v)} className={`flex-1 py-2 rounded-lg border font-mono text-sm font-bold transition-all ${tFormat===f.v?"border-orange-500 bg-orange-500/10 text-orange-400":"border-zinc-700 text-zinc-500 hover:border-zinc-600"}`}>{f.l}</button>
              ))}
            </div>
          </div>
        </div>
      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
        ...
        <div className="flex gap-6 overflow-x-auto pb-2">
          {bv.wRounds.map((rnd,ri)=>(
            <BracketColumn key={ri} label={ri===bv.wRounds.length-1?"Winner Final":`Fase ${ri+1}`} rounds={rnd} isAdmin={isAdmin} onMatch={m=>{setEditMatch(m);setS1(m.score1??'');setS2(m.score2??'');}}/>
          ))}
          {bv.gf&&<BracketColumn label="Grand Final" rounds={[bv.gf]} isAdmin={isAdmin} onMatch={m=>{setEditMatch(m);setS1(m.score1??'');setS2(m.score2??'');}}/>}
        </div>
      </div>
      <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4">
        ...
        <div className="flex gap-6 overflow-x-auto pb-2">
          {bv.lRounds.map((rnd,ri)=>(
            <BracketColumn key={ri} label={`Perdedores F${ri+1}`} rounds={rnd} isAdmin={isAdmin} onMatch={m=>{setEditMatch(m);setS1(m.score1??'');setS2(m.score2??'');}}/>
          ))}
        </div>
      </div>
      {editMatch&&isAdmin&&(
  ...
  return(
    <div className="min-h-screen bg-zinc-950 text-zinc-100">
      ...
      <div className="border-t border-zinc-900 mt-12 py-4 text-center">
        <span className="text-zinc-700 font-mono text-xs">RIVOTRICSMT — v3.0 — Firebase Realtime Database</span>
      </div>
    </div>
  );
}
